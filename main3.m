...
for d=1:4
    fidcount = fopen(strcat(root2,dataSetCount(d)),"r");
    dataSetName = split(dataSetNames(d),".");
    ...
    fidset = fopen(strcat(root2,dataSetNames(d)),"r");
        ...
        for i=1:nBlocks
            ...
            if i==1
                if ~strcmp(sequence,char(values(1)))
                    ...
                    fidVideo = fopen(strcat(root,video),"r");
                    if bitDepth==8
